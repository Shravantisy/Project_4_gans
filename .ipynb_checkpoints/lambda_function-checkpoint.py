 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "        weather_list = []\n",
    "        url = f\"http://api.openweathermap.org/data/2.5/forecast?q=Berlin&appid={'3ecd94eaf9e215f48060cfc4e140f1d7'}&units=metric\"\n",
    "        test = requests.get(url)\n",
    "\n",
    "        if test.status_code >= 200  and test.status_code <= 299:\n",
    "            for city in cities:\n",
    "                url = f\"http://api.openweathermap.org/data/2.5/forecast?q={city}&appid={'3ecd94eaf9e215f48060cfc4e140f1d7'}&units=metric\"\n",
